package com.saturn_dev.insurgencekills.util.file.yaml;
...
public class YamlFile {
    ...
    private void saveResource() {
        if (this.folder != null) {
            InsurgenceKills.getInstance().saveResource(this.folder + File.separator + this.name, false);
        } else {
            InsurgenceKills.getInstance().saveResource(this.name, false);
        }
    }
